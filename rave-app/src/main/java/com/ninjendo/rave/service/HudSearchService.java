...
@Service
public class HudSearchService {
	

	final static Logger logger = LoggerFactory.getLogger(HudSearchService.class);
	...
	@Autowired
	public HudSearchService(HudConfig config) {
		this.config = config;
	}
...
//	}
//	
//	public void downloadHudProperties(State stateCode) throws MissingDataException
//	{
...
//			    if (leads.size() > 0) 
//			    {
//			    	String jsonX = leads.get(0).toJson();
//			    	cache.save(leads);
