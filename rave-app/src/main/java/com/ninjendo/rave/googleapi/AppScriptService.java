...
public class AppScriptService {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in = AppScriptService.class.getResourceAsStream("/google-api/client_secret.json");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String scriptId = "M5NbouwoNrua0CBPRNX9NomuOb1CsJGSi";
        Script service = getScriptService();

        // Create an execution request object.
        ExecutionRequest request = new ExecutionRequest().setFunction("parseEmailMessages");
        ...
        try {
            ...
            if (op.getError() != null) {
            	...
            	System.out.println("Parsed HUD emails successfully!");
